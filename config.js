oohimport { watchFile, unwatchFile } from 'fs'
...
const defaultOwner = '254113649244';
...
//
global.botname = process.env.BOTNAME || 'TIMNANDEZ-AI';
global.pairingNumber = process.env.BOT_NUMBER || '254113649244' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['254113649244', '254113649244']
...
global.canal = 'https://whatsapp.com/dl/'
